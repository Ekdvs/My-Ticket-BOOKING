            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
              {TEAM.map((member) => (
                <div
                  ...
                  onClick={() =>
                    setActiveTeamMember(
                      activeTeamMember?.name === member.name ? null : member
                    )
                  }
                  className="cursor-pointer group"
                >
                  <div className={`bg-gray-900 border rounded-2xl p-6 text-center transition-all ${activeTeamMember?.name === member.name
