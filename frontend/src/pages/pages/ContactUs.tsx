      ...
      <div className="min-h-screen bg-gray-950 flex items-center justify-center px-6">
        <div className="max-w-md w-full bg-gray-900 border border-white/5 rounded-3xl p-10 text-center">
          ...
          <p className="text-gray-400 text-sm mb-1">
            Thanks, <span className="text-white font-semibold">{form.name}</span>. We've received your message.
          </p>
          <p className="text-gray-500 text-sm mb-6">
            Our team will reply to <span className="text-orange-400">{form.email}</span> within 2 hours.
          </p>
          <div className="bg-gray-800 rounded-2xl p-4 mb-6 text-left">
            <p className="text-xs text-gray-500 mb-1 uppercase tracking-wider font-semibold">Reference Number</p>
          ...
          <div className="bg-gray-900 border border-white/5 rounded-3xl p-8 space-y-5">
            ...
            <div>
              ...
              <div className="flex gap-2">
                {[
                  { val: "normal", label: "Normal", dot: "⚪" },
                  { val: "urgent", label: "Urgent", dot: "🔴" },
                ].map(({ val, label, dot }) => (
                  <button
                    key={val}
