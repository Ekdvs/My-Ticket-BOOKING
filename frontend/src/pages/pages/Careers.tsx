          ...
          <div>
            ...
            <div className="space-y-3">
              {jobs.map((job) => (
                <div
                  key={job.title}
                  className="bg-gray-900 border border-white/5 rounded-2xl px-6 py-5 flex items-center justify-between gap-4 hover:border-orange-500/30 transition-colors group"
                >
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-3 mt-2 flex-wrap">
                      <span className={`text-xs px-2 py-0.5 rounded-full font-medium ${deptColors[job.dept]}`}>
                        {job.dept}
                      </span>
